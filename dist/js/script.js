...
// "use strict";
var API_KEY = "93fd81fb24a8051d9ecb7f3250e75e28";
...
var menuIcon = document.querySelector(".sidebar__top--icon");
var searchIcon = document.querySelector(".search__icon");
var form = document.querySelector(".search__form");
var inputBox = document.querySelector(".search__input");
var navigation = document.querySelector(".mobile-menu");
var contentContainer = document.querySelector(".content");
var articleContainer = document.querySelector(".content__article--container");
var contentHeading = document.querySelector(".content__heading");
var prevBtn = document.querySelector(".content__pagination--left");
          ...
          while (1)
            switch ((_context.prev = _context.next)) {
              ...
              case 3:
                ...
                latest = _yield$Promise$all2[0];
                science = _yield$Promise$all2[1];
                business = _yield$Promise$all2[2];
...
var generateMarkup = function generateMarkup(item) {
  ...
  return '\n    <div class="article">\n    <div class="article__figure">\n      <img\n        src=\''
    .concat(
      imageUrl,
      '\'\n        alt="No Image Found"\n        class="article__image"\n      />\n    </div>\n    <p class="article__source">source : '
    )
    .concat(sourceName, ' </p>\n    <p class="article__date">Published At : ')
    .concat(publishedDate, '</p>\n    <p class="article__title">\n      ')
    .concat(title, '\n    </p>\n    <p class="article__description">\n      ')
    .concat(description, '\n    </p>\n    <a href="')
    .concat(
      link,
      '" target="_blank" class="article__button">read more</a>\n  </div>\n    '
    );
};
var renderData = function renderData(data, currPage) {
  currPage--;
  var startingPos = currPage * itemPerPage;
  var endingPos = startingPos + itemPerPage;
  data = data.slice(startingPos, endingPos);
  articleContainer.innerHTML = "";
  if (currentDomain === "latest")
    contentHeading.textContent = "Trending news right now";
  else contentHeading.textContent = "trending ".concat(currentDomain, " news ");
  data.forEach(function (item) {
    var html = generateMarkup(item);
    articleContainer.insertAdjacentHTML("beforeend", html);
  });
};
var renderSearchResults = /*#__PURE__*/ (function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1)
          switch ((_context2.prev = _context2.next)) {
            case 0:
              contentHeading.textContent = "Search results for ".concat(query);
              _context2.next = 3;
              return fetch(
                ""
                  .concat(cors, "http://api.mediastack.com/v1/news?access_key=")
  ...
  return function renderSearchResults(_x2) {
...
var renderSearchError = function renderSearchError() {
...
items.forEach(function (item) {
  item.addEventListener("click", function (e) {
    ...
    items.forEach(function (item) {
      return item.classList.remove("item-active");
    });
    e.target.classList.add("item-active");
    var target = e.target.textContent.toLowerCase();
...
[nextBtn, prevBtn].forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var btnName = e.target.textContent.toLowerCase();
    var data = dataContainer[currentDomain];
    var currPage =
      dataContainer[
        "curr" + currentDomain.charAt(0).toUpperCase() + currentDomain.slice(1)
      ];
    var maxPage = Math.floor(data.length / itemPerPage);
